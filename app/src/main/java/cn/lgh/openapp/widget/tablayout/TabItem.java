...
/**
 * TabItem is a special 'view' which allows you to declare tab items for a {@link cn.lgh.openapp.widget.tablayout.TabLayout}
 ...
 *
 * @see cn.lgh.openapp.widget.tablayout.TabLayout.Tab
 */
...
public final class TabItem extends View
{
    ...
    public TabItem(Context context, AttributeSet attrs) {
		...
		final TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, com.google.android.material.R.styleable.TabItem);
