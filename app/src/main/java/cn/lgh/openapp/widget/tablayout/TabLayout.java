...
package cn.lgh.openapp.widget.tablayout;
...
public class TabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link com.google.android.material.tabs.TabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link com.google.android.material.tabs.TabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    private boolean mHasSwitchAnim = false;
    private boolean mIsSelectedTextBold = false;
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.google.android.material.R.styleable.TabLayout, defStyleAttr, com.google.android.material.R.style.Widget_Design_TabLayout);

        mTabStrip.setSelectedIndicatorHeight(a.getDimensionPixelSize(com.google.android.material.R.styleable.TabLayout_tabIndicatorHeight, 0));
        mTabStrip.setSelectedIndicatorColor(a.getColor(com.google.android.material.R.styleable.TabLayout_tabIndicatorColor, 0));

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a.getDimensionPixelSize(com.google.android.material.R.styleable.TabLayout_tabPadding, 0);
        ...
        mTabTextAppearance = a.getResourceId(com.google.android.material.R.styleable.TabLayout_tabTextAppearance, com.google.android.material.R.style.TextAppearance_Design_Tab);
    ...
    public void setIndicatorBottomMargin(int margin) {
        mTabStrip.setIndicatorBottomMargin(margin);
    }

    public void setHasSwitchAnim(boolean has) {
        this.mHasSwitchAnim = has;
    }

    public void setHasRoundCorner(boolean b) {
        mTabStrip.setHasRoundCorner(b);
    }

    public void setTabTextSelectColor(@ColorInt int def, @ColorInt int select) {
        mTabTextColors = createColorStateList(def, select);
    }

    /**
     * scrollable 模式中，tab(使用newTab创建出来的tab)的最小宽度
     * 这个默认是160dp,如果不想要默认，则设置成0就可以
     *
     * @param width 最小宽度
     */
    public void setScrollableTabMinWidth(int width) {
        this.mScrollableTabMinWidth = width;
    }
    ...
    /**
     * Add a {@link com.google.android.material.tabs.TabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
    ...
    /**
     * Remove the given {@link com.google.android.material.tabs.TabLayout.OnTabSelectedListener} that was previously added via
    ...
    /**
     * Remove all previously added {@link com.google.android.material.tabs.TabLayout.OnTabSelectedListener}s.
     */
    ...
    /**
     * Returns the current mode used by this {@link com.google.android.material.tabs.TabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * The one-stop shop for setting up this {@link com.google.android.material.tabs.TabLayout} with a {@link ViewPager}.
     *
    ...
    class TabView extends LinearLayout {
        ...
        public void setSelected(final boolean selected) {
            ...
            if (mTextView != null) {
                ...
                if (mIsSelectedTextBold) {
                    mTextView.getPaint().setFakeBoldText(selected);
                }
            }
            if (mIconView != null) {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private int mSelectedIndicatorWidth = 0;
        private int mIndicatorBottomMargin = 0;
        private boolean mHasRound = false;
        private float left;
        private float right;
        ...
        void setIndicatorBottomMargin(int margin) {
            this.mIndicatorBottomMargin = margin;
        }

        void setHasRoundCorner(boolean b) {
            this.mHasRound = b;
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                ...
                if (mSelectedIndicatorWidth > 0 && getSelectedTabPosition() >= 0) {
                    ...
                    mSelectedIndicatorPaint.setAntiAlias(true);// 设置画笔的锯齿效果
                    RectF rect = new RectF(left, getHeight() - mSelectedIndicatorHeight - mIndicatorBottomMargin, right, getHeight() - mIndicatorBottomMargin);
                    if (mHasRound) {
                        canvas.drawRoundRect(rect, mSelectedIndicatorHeight / 2, mSelectedIndicatorHeight / 2, mSelectedIndicatorPaint);
                    } else {
     ...
     * necessary calls back to the provided {@link com.google.android.material.tabs.TabLayout} so that the tab position is
     * kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            if (tabLayout != null) {
                ...
                if (tabLayout.mHasSwitchAnim) {
                    if (mScrollState == SCROLL_STATE_IDLE && mPreviousScrollState == SCROLL_STATE_IDLE) {
                        //初始化状态，改变选中
                        tabLayout.mTabStrip.mIsDragged = false;
                    } else if (mScrollState == SCROLL_STATE_SETTLING && mPreviousScrollState == SCROLL_STATE_IDLE) {
                        tabLayout.mTabStrip.mIsDragged = false;
                    } else {
